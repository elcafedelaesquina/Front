              ...
              {estado.map((item) => (
                <div className={styles.itemCarta}>
                  ...
                  {item.map((producto, index) => (
                    <div key={index} className={styles.itemPriceOne}>
                      <p>{producto.name}</p>
                      <p>${producto.price}</p>{" "}
                      <ion-icon
                        name="trash-outline"
                        onClick={() => {
                          deleteProduct(producto.id_menu_product);
                        }}
                      ></ion-icon>
                    </div>
                  ))}
            ...
            <div className={styles.containerForms}>
              <div className={styles.container}>
                <form
                  ...
                  className={`${styles["input-boxes"]} ${"form-content"}`}
                >
                  <div className={styles["form-content"]}>
                    <div className={styles["form-create"]}>
                      <div className={styles.titleContainer}>
                        <h4 className={styles.title}>Crear Productos </h4>
