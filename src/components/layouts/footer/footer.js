  ...
  return (
    <div className='footer'>
        <ul>
            ...
            <li>Términos y configuración Privacidad y cookiesTérminos y condiciones
            Términos y configuración Privacidad y cookiesTérminos y condiciones
            </li>
            ...
            <li>Información Sobre Booking.com Cómo trabajamos Sostenibilidad Términos y configuración Privacidad y cookiesTérminos y condiciones</li>
        </ul>
