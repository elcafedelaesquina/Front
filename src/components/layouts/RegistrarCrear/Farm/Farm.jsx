        ...
        .then((data) => {
          ...
          if (mensaje === "Correo o contraseña invalida") {
            ...
            localStorage.setItem(
              "image",
              JSON.stringify(data.listFarm[0].image)
            );
            localStorage.setItem(
              "id_coffee",
              JSON.stringify(data.listFarm[0].id_farm)
            );
              ...
              <div className={styles.cover}>
                <div className={styles.front}>
                  <img
                    ...
                    src="https://media-cdn.tripadvisor.com/media/photo-s/07/19/08/26/finca-el-ocaso-salento.jpg"
                    alt=""
                  />
                    ...
                    <div className={styles["input-boxes"]}>
                      ...
                      <div className={styles["input-box textarea-container"]}>
                        <input
                          ...
                          placeholder="Breve descripción de tu Cafetería"
                        />
                      </div>
