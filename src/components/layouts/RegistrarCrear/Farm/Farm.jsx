...
export function Farm() {
  ...
  function register(){
   ...
   formulario.addEventListener('submit',(e)=>{
     ...
     fetch('https://apimainejetravel.azurewebsites.net/api/Farm/Guardar', {
       method: 'POST',
       body:formData
     })
    ...
    formularioLogin.addEventListener('submit',(e)=>{
      ...
      .then(data=>{
        ...
        if(mensaje==='Correo o contraseña invalida'){
          ...
          localStorage.setItem('name',JSON.stringify(data.listFarm[0].name))
          localStorage.setItem('image',JSON.stringify(data.listFarm[0].image))
          localStorage.setItem('id_coffee',JSON.stringify(data.listFarm[0].id_farm))
...
//https://media-cdn.tripadvisor.com/media/photo-s/07/19/08/26/finca-el-ocaso-salento.jpg
  ...
  <form ref={formularioLogin} className={styles['login-form']}>
    ...
    <div className={styles['input-boxes']}>
      <div className={styles['input-box']}>
        ...
        <input type="text" className={styles.type} name="Type" readOnly  placeholder='Enter your name' value={2}/>
  ...
  <div className={styles['signup-form']}>
    ...
    <div className={styles['input-boxes']}>
      <div className={styles['input-box']}>
        ...
        <input type="text" className={styles.type} name="Type" readOnly   value={2}/>
        <input type="text" className={styles.type} name="State" readOnly   value={'activo'}/>
        <input type="text" name='Name' placeholder='Nombre de Tu Finca'  />
